...
export const Summary: React.FC<SummaryProps> = ({ result }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl sm:text-3xl font-bold text-byggnads-dark">{t.wageSummary}</h2>
      
      {result.weeks.map((week) => (
        <div key={`${week.year}-W${week.weekNumber}`} className="card">
          <div className="bg-byggnads-blue-500 text-white px-4 sm:px-6 py-3 sm:py-4">
            <h3 className="text-lg sm:text-xl font-bold">
              {t.week} {week.weekNumber}, {week.year}
            </h3>
            <p className="text-xs sm:text-sm text-byggnads-blue-100 mt-1">
              {(() => {
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <table className="w-full text-[10px] sm:text-xs">
              <thead className="bg-byggnads-gray-100">
                <tr>
                  <th className="px-2 sm:px-3 py-2 text-left font-bold text-byggnads-dark border-b-2 border-byggnads-gray-300 sticky left-0 bg-byggnads-gray-100 z-10 min-w-[80px] sm:min-w-[100px]">{t.category}</th>
                  {week.days.map((day) => (
                    <th key={day.date} className="px-1 sm:px-2 py-2 text-center font-bold text-byggnads-dark border-b-2 border-byggnads-gray-300 min-w-[70px] sm:min-w-[100px]">
                      <div className="font-semibold">{day.date.split('-').slice(1).join('-')}</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-600">{getDayAbbr(language, day.dayOfWeek)}</div>
                      {day.startTime && day.endTime && (
                        <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-600">{day.startTime}–{day.endTime}</div>
                      )}
                      {day.isSick && (
                        <div className="text-[9px] sm:text-xs font-semibold text-byggnads-orange-600">{t.sickDay} {day.sickDay}</div>
                      )}
                    </th>
                  ))}
                  <th className="px-2 sm:px-3 py-2 text-right font-bold text-byggnads-dark border-b-2 border-byggnads-gray-300 sticky right-0 bg-byggnads-gray-100 z-10 min-w-[60px] sm:min-w-[80px]">{t.total}</th>
                </tr>
              </thead>
              <tbody>
                {/* Base Hours Row */}
                <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                  <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                    <div>{t.base}</div>
                    <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">{t.regularTime}</div>
                  </td>
                  {week.days.map((day) => (
                    <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                      <div className="font-semibold text-byggnads-dark">{fmt(day.baseHours)} {t.hours}</div>
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.basePay)} {t.currency}</div>
                    </td>
                  ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                    <div className="text-byggnads-dark">{fmt(week.baseHours)} {t.hours}</div>
                    <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.basePay)} {t.currency}</div>
                  </td>
                </tr>
                ...
                {week.OB1Hours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OB1 (20%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">05:00–06:00 {t.weekdays}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OB1Hours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OB1Pay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OB1Pay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OB2Hours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OB2 (40%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">18:00–22:00 {t.weekdays}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OB2Hours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OB2Pay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OB2Pay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OB3Hours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OB3 (70%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">22:00–05:00, {t.weekends}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OB3Hours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OB3Pay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OB3Pay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OVAHours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OVA (30%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">06:00–17:00 {t.weekdays}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OVAHours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OVAPay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OVAPay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OVBHours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OVB (50%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">05:00, 17:00–19:00 {t.weekdays}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OVBHours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OVBPay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OVBPay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OVCHours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                    <td className="px-2 sm:px-3 py-2 font-semibold text-byggnads-dark sticky left-0 bg-white z-10">
                      <div>OVC (70%)</div>
                      <div className="text-[9px] sm:text-xs font-normal text-byggnads-gray-500">19:00–22:00 {t.weekdays}</div>
                    </td>
                    {week.days.map((day) => (
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OVCHours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OVCPay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OVCPay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                {week.OVDHours > 0 && (
                  <tr className="border-b border-byggnads-gray-200 hover:bg-byggnads-gray-50 transition">
                      ...
                      <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                        {day.OVDHours > 0 && (
                          <>
                            ...
                            <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(day.OVDPay)} {t.currency}</div>
                          </>
                        )}
                      </td>
                    ))}
                    <td className="px-2 sm:px-3 py-2 text-right font-semibold sticky right-0 bg-white z-10">
                      ...
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">{fmt(week.OVDPay)} {t.currency}</div>
                    </td>
                  </tr>
                )}
                ...
                <tr className="border-t-2 border-byggnads-orange-500 bg-byggnads-orange-50">
                  <td className="px-2 sm:px-3 py-2 font-bold text-byggnads-dark sticky left-0 bg-byggnads-orange-50 z-10">
                    <div>Total</div>
                  </td>
                  {week.days.map((day) => (
                    <td key={day.date} className="px-1 sm:px-2 py-2 text-center">
                      <div className="font-bold text-byggnads-orange-600 text-xs sm:text-sm">{fmt(day.totalPay)}</div>
                      <div className="text-[9px] sm:text-xs text-byggnads-gray-600">kr</div>
                    </td>
                  ))}
                  <td className="px-2 sm:px-3 py-2 text-right font-bold sticky right-0 bg-byggnads-orange-50 z-10">
                    <div className="text-byggnads-orange-600 text-sm sm:text-base">{fmt(week.totalPay)}</div>
                    <div className="text-[9px] sm:text-xs text-byggnads-gray-600">kr</div>
                  </td>
                </tr>
              </tbody>
          ...
          <div className="bg-byggnads-gray-50 px-4 sm:px-6 py-4 sm:py-5 border-t-2 border-byggnads-gray-300">
            <h4 className="font-bold text-byggnads-dark mb-3 text-sm sm:text-base">{t.weekSummary}</h4>
            ...
            <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t-2 border-byggnads-orange-500">
              <div className="text-lg sm:text-xl font-bold text-byggnads-orange-600">
      ...
      {result.weeks.length > 1 && (
        <div className="card border-4 border-byggnads-orange-500 shadow-xl">
          <div className="bg-gradient-to-r from-byggnads-orange-500 to-byggnads-orange-600 text-white px-4 sm:px-6 py-4 sm:py-5">
            <h3 className="text-xl sm:text-2xl font-bold">{t.grandTotal} ({t.allWeeks})</h3>
          </div>
          
          <div className="p-4 sm:p-6 bg-white">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 text-xs sm:text-sm mb-3 sm:mb-4">
            ...
            <div className="pt-4 sm:pt-5 border-t-4 border-byggnads-orange-500 bg-gradient-to-br from-byggnads-orange-50 to-white rounded-lg px-4 sm:px-6 py-3 sm:py-4">
              <div className="text-2xl sm:text-3xl font-bold text-byggnads-orange-600">
